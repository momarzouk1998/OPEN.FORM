...
export default function ResetPasswordPage() {
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center p-4">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
          ...
          {success ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-700 font-medium">تم تغيير كلمة المرور بنجاح!</p>
              <p className="text-gray-400 text-sm mt-1">جاري تحويلك إلى صفحة تسجيل الدخول...</p>
            </div>
          ) : (
