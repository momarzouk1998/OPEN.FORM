...
const ADMIN_CARDS = [
  ...
  {
    title: 'الاشتراكات',
    description: 'إدارة اشتراكات المستخدمين وتجديدها',
  ...
  {
    title: 'طلبات السحب',
    description: 'إدارة طلبات السحب من النقاط والعمولات',
  ...
  {
    title: 'سجل العمليات',
    description: 'سجل كامل بكل العمليات والإجراءات الإدارية',
  ...
  {
    title: 'رسائل التواصل',
    description: 'إدارة رسائل الشكاوى والاقتراحات والاستفسارات',
    href: '/admin/messages',
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
